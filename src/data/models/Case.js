...
export default sequelize.define('Case', {
  ...
  award_amount_business: DataType.BIGINT,
  attorney_fees_business: DataType.BIGINT,
  ...
  award_amount_consumer: DataType.BIGINT,
  attorney_fees_consumer: DataType.BIGINT,
