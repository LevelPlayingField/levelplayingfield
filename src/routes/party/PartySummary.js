    ...
    <Row>
      ...
      <Col className={s.alignCenter}>
        {party.aggregate_data.dispositions && (
          <SummaryTable data={party.aggregate_data.dispositions} heading="Dispositions" headingQuery="disposition"
                        extraTerms={{party: party.name}}/>
        )}
      </Col>
      <Col className={s.alignCenter}>
        {party.aggregate_data.awards && (
          <SummaryTable data={party.aggregate_data.awards} heading="Awards" headingQuery="awarded"
